...
<div class="embed__gallery">
    <div class="embed__gallery-item">
        <img src="{{ '/assets/img/projects/nozzle/initialFEA.png' | relative_url }}" alt="Exploded view of final design"/>
        <p class="embed__caption">FEA of initial nozzle design.</p>
    </div>
    <div class="embed__gallery-item">
        <img src="{{ '/assets/img/projects/nozzle/pre-weld.png' | relative_url }}" alt="Exploded view of final design"/>
